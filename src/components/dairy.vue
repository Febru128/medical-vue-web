          ...
          <el-col :span="18">
            ...
            >
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-button type="primary"  plain @click="searchPatient()"
                      >点击查询患者信息</el-button>
                  </el-form-item>
                </el-col>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-button type="primary" plain @click="rb()">退费</el-button>
                  </el-form-item>
                </el-col>
  ...
  methods: {
    ...
    editSub() {
      ...
      that.drugData[that.editForm.index].amount =
        Number.parseInt(that.editForm.nums) *
        Number.parseInt(that.drugData[that.editForm.index].unitPrice);
    },
